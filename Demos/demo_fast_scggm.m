...
noiseY = ((chol(LambdaSimple,'lower')')\randn(q, n))';
Y = meanY + noiseY;

lambdaLambda = 0.5;
lambdaTheta = 1;
[estLambdaSimple, estThetaSimple, statsSimple] = fast_scggm(...
...
[estLambda, estTheta, estStats] = fast_scggm(Y, X, lambdaLambdas(1), lambdaThetas(1), options);
